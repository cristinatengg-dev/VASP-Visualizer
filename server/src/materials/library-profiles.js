...
const profiles = [
  ...
  },
  {
    ...
    domainSources: [
      ...
      {
        id: 'nasa-tps',
        label: 'NASA Thermal Protection Materials',
        mode: 'metadata',
        category: 'thermal-protection',
        access: 'open web',
        homepage: 'https://www.nasa.gov/thermal-protection-materials-branch/',
        notes: 'Official NASA entry for PICA, TUFROC, reusable TPS, material response, testing, and fabrication capabilities.',
      },
      {
        id: 'nasa-ntrs',
        ...
        notes: 'Public NASA technical evidence for propulsion alloys, UHTCs, thermal protection, additive manufacturing, and qualification tests.',
      },
      {
        id: 'ecss-q70',
        label: 'ECSS-Q-ST-70 Materials and Processes',
        mode: 'license-first',
        category: 'qualification-standard',
        access: 'standard / license',
        homepage: 'https://ecss.nl/standard/ecss-q-st-70c-rev-2-materials-mechanical-parts-and-processes-15-september-2022/',
        notes: 'European space materials, mechanical parts, and processes product-assurance framework.',
      },
      {
        id: 'nist-jarvis',
        label: 'NIST JARVIS-DFT',
        mode: 'live-structure',
        category: 'computed-materials',
        access: 'open API',
        homepage: 'https://jarvis.nist.gov/',
        notes: 'Open inorganic structures and computed properties for ceramics, coatings, and electronic materials pre-screening.',
      },
    ],
  },
];
