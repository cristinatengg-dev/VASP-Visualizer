...
const KNOWLEDGE_DEVELOPMENT = false;
...
function App() {
  const [isAuthChecking, setIsAuthChecking] = useState(() => {
      if (KNOWLEDGE_DEVELOPMENT) return false;
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      ...
      <Route path="/knowledge" element={KNOWLEDGE_DEVELOPMENT ? <KnowledgeCenter /> : <AgentRoute><KnowledgeCenter /></AgentRoute>} />
