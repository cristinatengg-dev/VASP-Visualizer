            ...
            <div className="bg-white rounded-[24px] shadow-[0_4px_30px_rgba(0,0,0,0.05)] p-8 w-[400px] text-center relative ring-1 ring-black/5">
                ...
                {step === 'confirm' && (
                    <>
                        ...
                        <p className="text-sm text-gray-500 mb-8">
                            {type === 'batch'
                                ? `You are about to export ${count} image(s).`
                                : type === 'subscription'
                                    ? `Upgrade to${planName}plan.`
                                    : `You are about to export a${type === 'img' ? 'HD image' : 'trajectory video'}。`
                            }
                        </p>

                        <div className="bg-[#F9FAFB] p-6 rounded-[20px] mb-8 border border-gray-100">
                            <div className="text-xs text-gray-400 uppercase font-bold tracking-widest mb-2">Payment Amount</div>
                        ...
                        >
                            {cost === 0 ? 'Confirm Charge' : 'Proceed to Payment'}
                        </button>
                    </>
                )}
                    ...
                    <div className="py-10">
                        ...
                        <p className="text-gray-500 mt-2 font-medium">
                            {type === 'batch' ? 'Starting batch export...' :
                             type === 'subscription' ? 'Upgrading plan...' : 'Starting export...'}
                        </p>
                    </div>
                )}
                ...
                {step === 'error' && (
                    <div className="py-10">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 mb-2">Failed to create order</h3>
